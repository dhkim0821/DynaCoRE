...
class JPosTrajPlanningCtrl:public Controller{
    public:
        JPosTrajPlanningCtrl(RobotSystem* robot, int swing_foot, Planner* planner);
        ~JPosTrajPlanningCtrl();
        ...
        void setSwingTime(double swing_time){ end_time_ = swing_time; half_swing_time_ = end_time_/2.; }
