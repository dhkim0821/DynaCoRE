...
#include <Atlas_Controller/ContactSet/FixedBodyContact.hpp>
...
JPosCtrl::JPosCtrl(RobotSystem* robot):Controller(robot),
   ...
   ctrl_start_time_(0.)
{
    set_jpos_.resize(atlas::num_act_joint, 0.);
    amp_.resize(atlas::num_act_joint, 0.);
    freq_.resize(atlas::num_act_joint, 0.);
    phase_.resize(atlas::num_act_joint, 0.);
